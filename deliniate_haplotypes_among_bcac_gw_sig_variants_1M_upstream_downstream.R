...
map3k1_gwsig = fread("/zivlab/data3/jnierenberg/Data/rare_variant_functional_map3k1/chr5_map3k1_1M_upstream_downstream_gw_sig.txt") %>% 
  ...
  mutate(snp_id = ifelse(startsWith(phase3_1kg_id, "rs"), sub("\\:.*", "", phase3_1kg_id), paste0("chr", chr, ":", position_b37)),
         ...
         snp_id = replace(snp_id, snp_id=="chr5:56053745", "rs1581182989"),
         snp_id = replace(snp_id, snp_id=="chr5:56298904", "rs202030667"),
         snp_id = replace(snp_id, snp_id=="chr5:55961859", "rs1443548698")) 
...
fwrite(ld_matrix, file = "/zivlab/data3/jnierenberg/Data/rare_variant_functional_map3k1/independent_variants/ld_matrix_1kg_eur_1M_upstream_downstream.csv")
...
# Write file
fwrite(sig_with_haps, file = "/zivlab/data3/jnierenberg/Data/rare_variant_functional_map3k1/independent_variants/map3k1_gwsig_with_hap_blocks_1M_upstream_downstream.csv")
